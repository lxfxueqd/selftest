...
<div class="row-fluid">
	<h3 class="header blue lighter smaller">
		<form action="<?php echo U('Admin/Test/index');?>" method="get">
		<div class="row-fluid  dataTables_wrapper">
			<div class="span12" id="m_search_div">
				...
				<input name="id" value="<?php echo ($map["set_student_id"]); ?>" type="text" id="search_name" class="pull-right" placeholder="学生编号"/>
				<label class="control-label pull-right">自测名称：</label>
			</div>	
		</div>
		</form>
	</h3>
		...
		<tbody>
			<?php foreach ($data as $key => $val): ?>
				<tr>
					...
					<td><?php echo ($val["set_test_id"]); ?></td>
					<td><?php echo ($val["set_paper_id"]); ?></td>
					<td><?php echo ($val["set_student_id"]); ?></td>
					<td><?php echo ($val["set_start_time"]); ?></td>
					<td><?php echo ($val["set_end_time"]); ?></td>
					<td><?php echo ($val["set_grade"]); ?></td>
					<td><?php echo C('user_state')[$val['set_status']];?></td>
					<td>
