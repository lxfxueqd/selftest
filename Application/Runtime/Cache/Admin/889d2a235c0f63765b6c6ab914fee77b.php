...
<div class="row-fluid">
	<h3 class="header blue lighter smaller">
		<form action="<?php echo U('Admin/Exam/index');?>" method="get">
		<div class="row-fluid  dataTables_wrapper">
			<div class="span12" id="m_search_div">
				...
				<input name="name" value="<?php echo ($map["sei_exam_name"]); ?>" type="text" id="search_name" class="pull-right" placeholder="考试名称"/>
		...
		<tbody>
			<?php foreach ($data as $key => $val): ?>
				<tr>
					...
					<td><?php echo ($val["sei_exam_id"]); ?></td>
					<td>
						<?php echo ($val["sei_exam_name"]); ?>
					</td>
					<td><?php echo ($val["sei_paper_id"]); ?></td>
					<td><?php echo ($val["sei_teacher_id"]); ?></td>
					<td><?php echo ($val["sei_start_time"]); ?></td>
					<td><?php echo ($val["sei_end_time"]); ?></td>
					<td><?php echo C('user_state')[$val['sei_status']];?></td>
					<td>
