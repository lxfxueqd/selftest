...
tree_data['for-sale']['additionalParameters'] = {
	'children' : {
		'appliances' : {name: 'Appliances', type: 'item', data:'1', selected:true},
		'arts-crafts' : {name: 'Arts & Crafts', type: 'item', data:'2', selected:true},
		'clothing' : {name: 'Clothing', type: 'item', data:'3'},
		'computers' : {name: 'Computers', type: 'item', data:'4', selected:true},
		'jewelry' : {name: 'Jewelry', type: 'item', data:'5'},
		'office-business' : {name: 'Office & Business', type: 'item', data:'6'},
		'sports-fitness' : {name: 'Sports & Fitness', type: 'item', data:'7'}
	}
}
